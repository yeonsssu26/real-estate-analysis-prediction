...
# SPARK SET UP
export SPARK_MASTER_IP=192.168.0.6 # HOST -> IP
export SPARK_MASTER_HOST=master # new
...
# try2
#export HADOOP_CONF_DIR=/home/hadoop/hadoop-2.7.6/etc/hadoop
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/hadoop/hadoop-2.7.6/lib/native


export SPARK_MASTER_WEBUI_PORT=50099
